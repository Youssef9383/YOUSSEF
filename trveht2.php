...
'inline_keyboard'=>[[['text'=>"- 𝗦𝗢𝗨𝗥𝗖𝗘",'url'=>"t.me/$YO_US_EF_AL_BR_AZ_IL"]],]])]);}}
#┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
$re = $update->message->reply_to_message;
$me = $message->reply_to_message;  
$mem = $me->message_id; 
$YOUSSEF = str_replace("كله ","$YOUSSEF",$text); 
if($re){
if($text == "كله $YOUSSEF"){ 
bot('sendMessage',[ 
'chat_id'=>$chat_id, 
...
[['text'=>"✵⁞ المطور ⁞✵",'url'=>"t.me/YO_US_EF_AL_BR_AZ_IL_IAN"]],
]])
]); 
}
if($data == "NDVE" ){
...
$YOUSSEF = array_rand($YOUSSEF,1);
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"*
نـسبـهہ الحـب والـثـقهہ بـيـن $namex[0] و $namex[1] هـي 💕🔰*
 »  [$YOUSSEF[$YOUSSEF]](https://t.em/$YO_US_EF_AL_BR_AZ_IL_IAN)  «",
'parse_mode'=>"markdown", 
'reply_to_message_id'=>$message->message_id,
]);
}}
...
bot('sendphoto',[
'chat_id'=>$chat_id,
'photo'=>"https://t.me/YO_US_EF_AL_BR_AZ_IL/1161",
'caption' =>"┏•━•━•━ 『𝗦𝗢𝗨𝗥𝗖𝗘』 ━•━•━•┓
╏⍟ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 
╏⍟ 𝙸𝙽𝙵𝙾 𝙳𝙴𝚅 𝗦𝗢𝗨𝗥𝗖𝗘  
╏⍟ $time
...
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[['text'=>"✵⁞ 𝙱𝙾𝚃 𝙳𝙴𝚅 ⁞✵",'url'=>"t.me/$YO_US_EF_AL_BR_AZ_IL"]],
[['text'=>"✵⁞ 𝙳𝙴𝚅 ⁞✵",'url'=>"t.me/$YO_US_EF_AL_BR_AZ_IL_IAN"],['text'=>"✵⁞ 𝙲𝙷  ⁞✵",'url'=>"t.me/$YO_US_EF_AL_BR_AZ_IL"]],
]])
]); 
}
############     
...
⋄︙[تفاصيل الملف](https://t.me/YO_US_EF_AL_BR_AZ_IL)
",'parse_mode'=>"markdown",'disable_web_page_preview'=>true,
  'reply_to_message_id'=>$message_id,
'reply_markup'=>$inlinebutton,
 ]);
