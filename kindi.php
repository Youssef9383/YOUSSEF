<?php
$token = "6020429439:AAEIMdCkI-4ERyTMuT1pmClRzqjtyuQRSIU"; // توكنك
$token2 = "6020429439:AAEIMdCkI-4ERyTMuT1pmClRzqjtyuQRSIU";// توكنك
...
#############
$BRAZILIAN =5911835215;
$admin = "5911835215";
$Dev = array("$admin","5911835215");
$eri = array("$admin","5911835215");
$sudo = "$admin";
$buy = "YO_US_EF_AL_BR_AZ_IL_IAN";
$DevUser = "@$YO_US_EF_AL_BR_AZ_IL_IAN";
$devchink = "YO_US_EF_AL_BR_AZ_IL";
$idBot= 6020429439;
$idbot = "$idBot";
$userbot = "Shanks45bot";
$chsource = "@$YO_US_EF_AL_BR_AZ_IL_IAN";
############
...
$sttingsch = json_decode(file_get_contents("YOUSSEF.𓆩 ˹ 𝐵𝑅𝐴𝑍𝐼𝐿𝐼𝐴𝑁 ˼ 𓆪"),1);
$re = $update->message->reply_to_message;
$re_id = $update->message->reply_to_message->from->id;
$settingdev = json_decode(file_get_contents("YOUSSEF.𓆩 ˹ 𝐵𝑅𝐴𝑍𝐼𝐿𝐼𝐴𝑁 ˼ 𓆪"),true);
...
# كود حجم الملف لـ @YO_US_EF_AL_BR_AZ_IL_IAN #
