...
if(in_array($YOUSSEF,$eri)){
$inf = "مبرمج السورس";
}
elseif(in_array($YOUSSEF,$nazar) ){
$inf = "منشئ اساسي";
}
elseif(in_array($YOUSSEF,$carlos) ){
$inf = "المنشئ";
}
elseif(in_array($YOUSSEF,$Dev) ){
$inf = "مطور اساسي";
}
elseif(in_array($YOUSSEF,$developer) ){
$inf = "مطور ثانوي";
}
...
elseif(in_array($YOUSSEF,$manger) ){
$inf = "المدير";
}
elseif(in_array($YOUSSEF,$AUBEHAB) ){
$inf = "مدير عام ";
}
elseif(in_array($YOUSSEF,$admin_user) ){
$inf = "البوديقارد";
}
elseif(in_array($YOUSSEF,$mmyaz) ){
$inf = "العسل  مميز";
