...
✵⁞*[𝐒𝐎𝐔𝐑𝐂𝐄 𓆩 ˹ 𝐵𝑅𝐴𝑍𝐼𝐿𝐼𝐴𝑁 ˼ 𓆪 𝐁𝐎𝐓](https://t.me/whisky_bot003)*
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⌯︙*[𝗦𝗢𝗨𝗥𝗖𝗘 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 ⁦⁦ㇱ](https://t.me/YO_US_EF_AL_BR_AZ_IL)*
⌯︙*[𝗦𝗢𝗨𝗥𝗖𝗘 𝗜𝗡𝗦𝗧𝗔𝗟𝗟](https://t.me/YO_US_EF_AL_BR_AZ_IL)*
⌯︙*[𝐂𝐇𝐀𝐍𝐆𝐈𝐍𝐆 𝐈𝐃 𝐂𝐇𝐀𝐍𝐍𝐄𝑳](https://t.me/YO_US_EF_AL_BR_AZ_IL)*
⌯︙*[𝐓𝐄𝐀𝐌 𝐒𝐎𝐔𝐑𝐂𝐄](@SA_T_OU)*
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
⌯︙*[𝗰𝗼𝗻𝗻𝗲𝗰𝘁 𝗱𝗲𝘃](https://t.me/$YO_US_EF_AL_BR_AZ_IL_IAN)**
",'parse_mode'=>"Markdown",
...
#######
if( $text=="تفطين" && $rt){
if ( $status == 'creator' or $status == 'administrator' or in_array($from_id,$Dev) or in_array($from_id,$developer) or in_array($from_id,$YOUSSEF) or in_array($from_id,$eri) or in_array($from_id,$nazar)) {
if ($tc == 'group' | $tc == 'supergroup'){
if ( $statusrt != 'creator' && $statusrt != 'administrator' && !in_array($re_id,$Dev) && !in_array($re_id,$manger) && !in_array($re_id,$admin_user) && !in_array($re_id,$manger) && !in_array($re_id,$developer) && !in_array($re_id,$YOUSSEF) && !in_array($re_id,$eri) && !in_array($re_id,$nazar)) {
...
$fr = file_get_contents("https://abu-ehab-vip.ml/Abuehab/api(YOUSSEF)translate.php?Language=ar&TO=fa&text=".$s);
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"$fr",
'reply_to_message_id'=>$message->message_id,
...
$enar = file_get_contents("https://abu-ehab-vip.ml/Abuehab/api(YOUSSEF)translate.php?Language=en&TO=ar&text=".$H);
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"$enar",
'reply_to_message_id'=>$message->message_id,
...
$arfr = file_get_contents("https://abu-ehab-vip.ml/Abuehab/api(YOUSSEF)translate.php?Language=fa&TO=ar&text=".$Q);
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"$arfr",
'reply_to_message_id'=>$message->message_id,
...
$aren = file_get_contents("https://abu-ehab-vip.ml/Abuehab/api(YOUSSEF)translate.php?Language=ar&TO=en&text=".$W);
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"$aren",
'reply_to_message_id'=>$message->message_id,
...
$artr = file_get_contents("https://abu-ehab-vip.ml/Abuehab/api(YOUSSEF)translate.php?Language=ar&TO=tr&text=".$E);
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"$artr",
'reply_to_message_id'=>$message->message_id,
...
$trar = file_get_contents("https://abu-ehab-vip.ml/Abuehab/api(YOUSSEF)translate.php?Language=ar&TO=tr&text=".$R);
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"$trar",
'reply_to_message_id'=>$message->message_id,
...
$entr = file_get_contents("https://abu-ehab-vip.ml/Abuehab/api(YOUSSEF)translate.php?Language=en&TO=tr&text=".$Y);
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"$entr",
'reply_to_message_id'=>$message->message_id,
...
$tren = file_get_contents("https://abu-ehab-vip.ml/Abuehab/api(YOUSSEF)translate.php?Language=tr&TO=en&text=".$T);
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"$tren",
'reply_to_message_id'=>$message->message_id,
...
$result = $result."⋄︙ $z ← [$nameMute](https://t.me/$YO_US_EF_AL_BR_AZ_IL_IAN) - $idMute"."\n";
}
if(!$result){
...
file_put_contents("data/YOUSSEF.ogg",file_get_contents($file));
bot('sendvoice',[
'chat_id'=>$chat_id,
'voice'=>new CURLFile("data/YOUSSEF.ogg"),
'caption'=>"".$em." تم تحويل الفيديو ← بصمة",
]);
unlink("data/YOUSSEF.ogg");
}
...
file_put_contents("data/YOUSSEF.mp3",file_get_contents($file));
bot('sendaudio',[
'chat_id'=>$chat_id,
'audio'=>new CURLFile("data/YOUSSEF.mp3"),
'caption'=>"".$em." تم تحويل البصمة ← اغنية",
]);
unlink("data/YOUSSEF.mp3");
}
...
file_put_contents("data/YOUSSEF.png",file_get_contents($file));
bot('sendsticker',[
'chat_id'=>$chat_id,
'sticker'=>new CURLFile("data/YOUSSEF.png"),
]);
unlink("data/YOUSSEF.png");
}
...
file_put_contents("data/YOUSSEF.jpg",file_get_contents($file));
bot('sendphoto',[
'chat_id'=>$chat_id,
'photo'=>new CURLFile("data/YOUSSEF.jpg"),
'caption'=>"⋄︙تم تحويل الملصق ← صوره",
]);
unlink("data/YOUSSEF.jpg");
}
#######
...
$mabYOUSSEF = count($pirvate)-1;
$groYOUSSEF = count($groups)-1;
...
########
if($text == "⋄ تجربة السورس"){if(in_array($from_id,$Dev) or in_array($from_id,$eri)) {bot("sendmessage",['chat_id'=>$chat_id,'text'=>"✵⁞ *اليك قائمة تجربة السورس*\n━━━━━━━━━━━━━\n⌯⁞ ['قروب تجربة السورس](https://t.me/$YO_US_EF_AL_BR_AZ_IL)\n⌯⁞ [قناة شروحات السورس](https://t.me/YO_US_EF_AL_BR_AZ_IL)\n━━━━━━━━━━━━━\n⌯⁞ [مبرمج السورس](https://t.me/$YO_US_EF_AL_BR_AZ_IL_IAN)",'parse_mode'=>"Markdown",'disable_web_page_preview'=> true ,'reply_to_message_id'=>$message_id,'reply_markup'=>json_encode(['inline_keyboard'=>[[['text'=>"⌯⁞ قروب تجربة السورس ⁞⌯",'url'=>"t.me/$YO_US_EF_AL_BR_AZ_IL_IAN"]],[['text'=>"⌯⁞ مبرمج السورس ⁞⌯",'url'=>"t.me/$YO_US_EF_AL_BR_AZ_IL_IAN"]],]])]);}}
#######
...
⋄︙تغير الايدي ↫ تغ
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
[𝗦𝗢𝗨𝗥𝗖𝗘 𓆩 ˹ 𝐵𝑅𝐴𝑍𝐼𝐿𝐼𝐴𝑁 ˼ 𓆪](https://t.me/YO_US_EF_AL_BR_AZ_IL_IAN)",
...
#-----------------------#
$bot_id = "$idbot";
$YOUSSEF = file_get_contents("data/YOUSSEF.json");
$YOUSSEFs = file_get_contents("data/YOUSSEFs.json");
if($text=="ضع ترحيب عام"){
file_put_contents("data/YOUSSEFs.json","$from_id");
if( in_array($from_id,$Dev)){
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"
...
file_put_contents("data/YOUSSEF.json","YOUSSEF");
}}
if($text and $YOUSSEF =="YOUSSEF" and $YOUSSEFs == $from_id){
if( in_array($from_id,$Dev)){
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"
...
file_put_contents("YOUSSEF.ogg",$get);
bot('deleteMessage',[
...
'chat_id'=>$update->callback_query->message->chat->id,
'message_id'=>$update->callback_query->message->message_id,
'voice'=>new CURLFile("YOUSSEF.ogg"),
'caption' =>"*
⋄︙تم تحميل ← Voice
⋄︙الاغنية ← $title
*",
...
# --     Source 𓆩 ˹ 𝐵𝑅𝐴𝑍𝐼𝐿𝐼𝐴𝑁 ˼ 𓆪     --
echo "source 𓆩 ˹ 𝐵𝑅𝐴𝑍𝐼𝐿𝐼𝐴𝑁 ˼ 𓆪";