...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[["text"=>"ـ المطـور 🙇‍♂",'url'=>"t.me/$YO_US_EF_AL_BR_AZ_IL_IAN"]],]])]);}}}}
$starttext = file_get_contents("data/start.txt");
if($text=="/start" and $starttext != null){
if($tc == "private"){
$st1 = file_get_contents("data/startlock.txt");
...
⌯ معرف المطور ⋙ $YO_US_EF_AL_BR_AZ_IL_IAN
⌯ [للمزيد اضغط هنا](t.me/$t.me/YO_US_EF_AL_BR_AZ_IL)
➖
",'parse_mode'=>"markdown",
'disable_web_page_preview'=>true,
  'reply_to_message_id'=>$message->message_id,
...
'disable_web_page_preview'=>true,
  'reply_to_message_id'=>$message->message_id,
        'reply_markup'=>json_encode([
          'inline_keyboard'=>[  
                [['text'=>'','url'=>'https://t.me/$YO_US_EF_AL_BR_AZ_IL']],
               ]])]);}}}
...
✵ تم ارسال رسالتك لـ المطور ✓
⌯ معرف المطور ⋙ $YO_US_EF_AL_BR_AZ_IL_IAN
⌯ [للمزيد اضغط هنا](t.me/$YO_US_EF_AL_BR_AZ_IL)
➖
",'parse_mode'=>"markdown",
'disable_web_page_preview'=>true,
'reply_to_message_id'=>$message->message_id,
...
",'parse_mode'=>'MarkDown', 'disable_web_page_preview'=>true,
 ...
 'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"",'url'=>"t.me/$YO_US_EF_AL_BR_AZ_IL"]],
]])
]);
}}}
$Twassl = file_get_contents("twassl.txt");
...
$result = $result."⋄︙ $z ← [$namekakeiic](https://t.me/$YO_US_EF_AL_BR_AZ_IL) - $idkakeiic"."\n";
}
if(!$result){
...
[['text'=>"𝘁𝗲𝗲𝗺 𓆩 ˹ 𝐵𝑅𝐴𝑍𝐼𝐿𝐼𝐴𝑁 ˼ 𓆪.",'url'=>"https://t.me/SA_T_OU"]],
]])]);}
$ex = explode("#",$data);
...
if ($text == "اذاعه للكل" || $text == "اذاعه عام" ||$text == "⋄ اذاعه عام" || $text =="📤¦  عام" and $from_id == $sudo){
    file_put_contents("Fri3nd_s/iBadlz.txt","YO_US_EF_AL_BR_AZ_IL");
    bot('sendmessage',[
    'chat_id'=>$chat_id,
    'text'=>"*✵⁞ اهلا حبيبي♥ الـمطور ، قم بأرسال رسالتك
⌯⁞ ملاحظةهہ : يمكنك استعمال الماركداون ، *",
...
if($message and $GG1ZZ == "YO_US_EF_AL_BR_AZ_IL" and $from_id == $sudo ){
    for ($i=0; $i<count($groups); $i++) { 
        bot('sendMessage',[
          'chat_id'=>$groups[$i],
          'text'=>"$text",
...
$YOUSSEF = count($pirvate)-1;
bot('sendMessage',[
          'chat_id'=>$chat_id,
          'text'=>"*✵⁞ اهلا حبيبي♥ الـمطور ، 
 ⌯⁞ تم ارسال رسالتك الى ⋙ $YOUSSEF عضوا
و ⋙ $YOUSSEF مجموعة*",
'parse_mode'=>"MARKDOWN",
   'reply_to_message_id'=>$message->message_id
   ]);
