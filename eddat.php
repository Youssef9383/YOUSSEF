...
"chat_id"=>$chat_id,
"text"=>"
".$em." تمام حبيبي البرازيلي دز العدد لي تبيه🤤♥
",'parse_mode'=>"MARKDOWN",
...
if ($text == "تفعيل بوت البرازيلي" or $text == "⋄ تفعيل بوت البرازيلي" and in_array($from_id,$Dev)){
...
file_put_contents("data/tiger.json","YOUSSEF");
}}
if($text and $YOUSSEF =="YOUSSEF" and $YOUSSEF == $from_id){
if ($status == 'creator' or in_array($from_id,$Dev) or in_array($from_id,$manger) or in_array($from_id,$admin_user) or in_array($from_id,$developer) or in_array($from_id,$carlos) or in_array($from_id,$nazar) or in_array($from_id,$eri)) {
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"
